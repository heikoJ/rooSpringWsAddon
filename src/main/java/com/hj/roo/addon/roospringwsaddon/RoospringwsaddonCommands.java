...
@Service
public class RoospringwsaddonCommands implements CommandMarker { // All command types must implement the CommandMarker interface
    
    /**
     * Get a reference to the RoospringwsaddonOperations from the underlying OSGi container
     */
    @Reference private RoospringwsaddonOperations operations;
     ...
     */
    @CliAvailabilityIndicator({ "roospringwsaddon setup", "roospringwsaddon add", "roospringwsaddon all" })
     ...
     * @param type 
     */
    @CliCommand(value = "roospringwsaddon add", help = "Some helpful description")
     ...
     * 
     */
    @CliCommand(value = "roospringwsaddon all", help = "Some helpful description")
    public void all() {
     ...
     * 
     */
    @CliCommand(value = "roospringwsaddon setup", help = "Setup Roospringwsaddon addon")
    public void setup() {
        operations.setup();
    }
}