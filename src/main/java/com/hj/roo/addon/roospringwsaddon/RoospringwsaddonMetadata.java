 ...
 * @since 1.1.0
 */
public class RoospringwsaddonMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {

    // Constants
    private static final String PROVIDES_TYPE_STRING = RoospringwsaddonMetadata.class.getName();
    ...
    public RoospringwsaddonMetadata(String identifier, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata) {
